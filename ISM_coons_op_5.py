...
nohup python -u ISM_coons_op_5.py \
...
nohup python -u ISM_coons_op_5.py   --tfrecord_glob "/home/ainsworth/master/dataset/tfrecords_ruled/*.tfrecord"   --epochs 20   > "$LOG" 2>&1 &
...
'''
changes
1 pad value swapable
2 masked loss with pad term
3 add option for chamfer loss
'''
